...
### Цвета
- \`text-black\` (#464646) - Основной цвет
- \`text-gray\` (#999999) - Вторичный цвет  
...
Подробное руководство доступно в [Typography Guide](/docs/typography.md)
        `
      }
    }
  }
...
**HTML + CSS Classes:**
\`\`\`html
<h1 class="display-xl bold">Главный заголовок</h1>
\`\`\`
